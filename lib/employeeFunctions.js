...
const  {add_emp_menu, emp_by_mgr_menu, emp_by_dept_menu, get_emp_to_update_menu, update_emp_menu}  = require('./menus');
...
const updateEmployee = async ()=>{
  ...
  let emp_id = await getEmployeeToUpdate();
  ...
  let emp_data = await inquirer.prompt(update_emp_menu(emp_id));


}

const getEmployeeToUpdate = async ()=>{
  let emp_choice = await inquirer.prompt(get_emp_to_update_menu);
  //return the employee id to update
  return emp_choice.emp_to_update
}
